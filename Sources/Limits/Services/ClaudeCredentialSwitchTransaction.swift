...
enum ClaudeCredentialSwitchTransactionError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .rollbackFailed:
            return L10n.tr("claude.switch.rollback_failed")
        }
    }
}
...
struct ClaudeCredentialSwitchResult: Sendable {
    let credential: Data
    let status: ClaudeAuthStatus
}

struct ClaudeCredentialSwitchTransaction: Sendable {
