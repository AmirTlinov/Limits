...
enum CodexAuthSwitchTransactionError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .rollbackFailed:
            return L10n.tr("account.switch.rollback_failed")
        }
    }
}

protocol CodexAccountValidating: Sendable {
    func validate(authData: Data) async throws -> AccountValidationResult
}

extension CodexAccountService: CodexAccountValidating {}

struct CodexAuthSwitchTransaction: Sendable {
