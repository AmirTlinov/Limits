...
public enum AsyncCommandRunnerError: LocalizedError, Equatable {
...
public struct AsyncCommandResult: Sendable, Equatable {
...
public struct AsyncCommandRunner: Sendable {
    public init() {}
